...
output_file = "/pscratch/sd/b/bogensch/E3SM_simulations/iopdiags_OBS_and_LES_files/DP_EAMxx/GOAMAZON_singlepulse.obs.ARMCMBE.dpxx_format.nc"
time_offset = 278.5
...
three_d_vars = [
    ("cld_frac", "cldfrac_tot_for_analysis_horiz_avg", 1.0/100.),
]
