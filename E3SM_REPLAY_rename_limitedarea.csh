...
setenv finalfile E3SMreplay_{$file}
...
while($phys_ind <= $numphysics)
  ...
  ncks -h -A -v {$physvars[$phys_ind]}_$latlon $file temp_physics.nc
  @ phys_ind++
...
while($dyn_ind <= $numdynamics)
  ...
  ncks -h -A -v {$dynvars[$dyn_ind]}_$latlon $file temp_dynamics.nc
  @ dyn_ind++

end # variable loop

# bring all other necessary variables to the dynamics file
ncks -h -A -v hyai $file temp_dynamics.nc
ncks -h -A -v hybi $file temp_dynamics.nc
ncks -h -A -v time $file temp_dynamics.nc
ncks -h -A -v date $file temp_dynamics.nc
ncks -h -A -v datesec $file temp_dynamics.nc
ncks -h -A -v time_bnds $file temp_dynamics.nc
ncks -h -A -v time_written $file temp_dynamics.nc
ncks -h -A -v ndbase $file temp_dynamics.nc
ncks -h -A -v nsbase $file temp_dynamics.nc
ncks -h -A -v nbdate $file temp_dynamics.nc
ncks -h -A -v bdate $file temp_dynamics.nc
ncks -h -A -v mdt $file temp_dynamics.nc
ncks -h -A -v ndcur $file temp_dynamics.nc
ncks -h -A -v nscur $file temp_dynamics.nc
ncks -h -A -v co2vmr $file temp_dynamics.nc
ncks -h -A -v ch4vmr $file temp_dynamics.nc
ncks -h -A -v n2ovmr $file temp_dynamics.nc
ncks -h -A -v f11vmr $file temp_dynamics.nc
ncks -h -A -v f12vmr $file temp_dynamics.nc
ncks -h -A -v sol_tsi $file temp_dynamics.nc
ncks -h -A -v tsec $file temp_dynamics.nc
ncks -h -A -v nsteph $file temp_dynamics.nc
