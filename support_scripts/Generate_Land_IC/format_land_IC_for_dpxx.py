...
# Choose your site.  SGP or GOAMAZON locations predefined.  Else chose CUSTOM
#  but be sure to input the lat and lon of that location below.
site = 'GOAMAZON'

# Should be as close to the start date and time of your simulation as possible
input_date = '2014-01-01-00000'  # format: yyyy-mm-dd-sssss

# Enter the geometry of your DP-EAMxx simulation.  The below parameters should
#  EXACTLY match what you plan to use in your simulation script.
num_ne_x = 20
num_ne_y = 20

# Case name and root directory where your ELM restart files reside
input_case = 'Generate_land_IC_I2000.ne30pg2_ne30pg2.001a'
input_file_root = '/pscratch/sd/b/bogensch/E3SM_simulations/'+input_case+'/run'

# Path where you want your DPxx formatted ELM initial condition file to be placed
