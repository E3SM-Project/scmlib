...
#######  of the scmlib repo to get you started.
  ...
  setenv casename scream_dpxx_LASSO_SGP_2019-05-17
...
# Case specific information kept here
  ...
  set startdate = 2019-05-17 # Start date in IOP file
  set start_in_sec = 43200 # start time in seconds in IOP file
  set stop_option = nhours
  set stop_n = 15
  set iop_file = LASSO_SGP_2019-05-17_iopfile_4scam.nc #IOP file name
