...
site = 'SGP'
start_date = '2011-01-01-00000'  # format: yyyy-mm-dd-sssss
num_days = 365  # <== number of days to loop over

num_ne_x = 20
num_ne_y = 20

input_file_root = '/pscratch/sd/b/bogensch/E3SM_simulations/IELM.ne30pg2_ne30pg2.ERA5_GoAmazon.003a/run'
input_case = 'IELM.ne30pg2_ne30pg2.ERA5_GoAmazon.003a'

output_path = '/pscratch/sd/b/bogensch/dp_screamxx/land_ic/sgp_hindcasts/'
...
seconds_str = start_date[11:]
for i in range(num_days):
    date_obj = base_date + timedelta(days=i)
    formatted_date = date_obj.strftime("%Y-%m-%d") + f"-{seconds_str}"
