...
#######  CGILS_s11_cntl
#######  Stratocumulus location - control
#######
...
#######  of the scmlib repo to get you started.
  ...
  setenv casename scream_dpxx_CGILS_s11_cntl
...
# Case specific information kept here
  set lat = 32.0 # latitude
  set lon = 231.0 # longitude
  ...
  set stop_n = 10
  set iop_file = CGILS_s11_cntl_iopfile_4scam.nc #IOP file name
...
# Create new case
  ./create_newcase -case $casename --script-root $temp_case_scripts_dir -mach $machine -project $PROJECT -compset $compset -res $grid --compiler $compiler --driver mct
...
# Get local input data directory path
  ...
  ./xmlchange SSTICE_DATA_FILENAME="$input_data_dir/ocn/docn7/SSTDATA/sst_HadOIBl_bc_1x1_clim_c011425_CGILS_s11_cntl.nc"
