...
#######  of the scmlib repo to get you started.
  ...
  setenv casename scream_dpxx_CGILS_s12_cntl
...
# Case specific information kept here
  ...
  set stop_n = 10
  set iop_file = CGILS_s12_cntl_iopfile_4scam.nc #IOP file name
...
# Get local input data directory path
  ...
  ./xmlchange SSTICE_DATA_FILENAME="$input_data_dir/ocn/docn7/SSTDATA/sst_HadOIBl_bc_1x1_clim_c011425_CGILS_s12_cntl.nc"
