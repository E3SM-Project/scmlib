...
#######  GOAMAZON_singlepulse
#######  Transition from shallow cumulus to deep cumulus (single pulse)
#######
...
#######  of the scmlib repo to get you started.
  ...
  setenv casename scream_dpxx_GOAMAZON_singlepulse
...
# Case specific information kept here
  ...
  set startdate = 2014-10-05 # Start date in IOP file
  set start_in_sec = 43200 # start time in seconds in IOP file
  set stop_option = nhours
  set stop_n = 12
  set iop_file = GOAMAZON_singlepulse_iopfile_4scam.nc #IOP file name
