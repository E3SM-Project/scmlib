...
#######  TRACER
#######  Convection during ARM TRACER field campaign
#######
#######  Script Author: P. Bogenschutz (bogenschutz1@llnl.gov)
#######  Forcing provided by: Raymond Oware and Youtong Zheng
#######
#######  IMPORTANT:
...
#######  of the scmlib repo to get you started.
  ...
  setenv casename scream_dpxx_TRACER
...
# Case specific information kept here
  set lat = 29.75 # latitude
  set lon = 264.550 # longitude
  ...
  set startdate = 2022-07-01 # Start date in IOP file
  set start_in_sec = 00000 # start time in seconds in IOP file
  set stop_option = ndays
  set stop_n = 91
  set iop_file = TRACER_iopfile_4scam.nc #IOP file name
