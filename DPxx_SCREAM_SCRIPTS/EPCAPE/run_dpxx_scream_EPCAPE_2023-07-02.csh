...
#######  of the scmlib repo to get you started.
  ...
  setenv casename scream_dpxx_EPCAPE_2023-07-02
...
# Case specific information kept here
  ...
  set startdate = 2023-07-02 # Start date in IOP file
  set start_in_sec = 00000 # start time in seconds in IOP file
  set stop_option = nhours
  set stop_n = 66
  set iop_file = EPCAPE_2023-07-02_iopfile_4scam.nc #IOP file name
