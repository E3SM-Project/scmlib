...
#######  BEGIN USER DEFINED SETTINGS
  ...
  setenv casename run_e3sm_scm_DYNAMO_northsounding
...
#######  - If the user wants to change the startdate of the case. 
#######    This is very useful for long cases, where the user only wants
#######	   to simulate a subset of the case.  In this instance, the user
#######	   needs to modify the "startdate" and "stop_n" options.
###########################################################################
###########################################################################
###########################################################################
