...
def main_web(casename,casedir):
    ...
    DP_diagnostics_functions.replace_string("DP_diagnostics_template.html","DP_diagnostics.html",\
                                             replacements)
                
    move("DP_diagnostics.html",casedir+"/DP_diagnostics.html")           
...
def sets_web(casename,casedir,varstoplot,setnum,setname,width,height):
    ...
    DP_diagnostics_functions.replace_string("set_template.htm","set_working.htm",\
                                             replacements)
