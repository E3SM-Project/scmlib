...
setenv casename scream_dp_DYCOMSrf01-EAMxx

# Set the case directory here
setenv casedirectory /home/tccleve/E3SM-Project/SCREAM/cime_scratch_dir

# Directory where code lives
setenv code_dir /home/tccleve/E3SM-Project/SCREAM/scream

# Code tag name
#setenv code_tag SCREAM_DP

# Name of machine you are running on (i.e. cori, anvil, etc)
setenv machine sandia-workstation
...
#./xmlchange RUN_STARTDATE="$startdate",START_TOD="$start_in_sec"
./xmlchange STOP_OPTION="$stop_option",STOP_N="$stop_n"

./xmlchange HIST_N=1,HIST_OPTION=nhours
...
./xmlchange PTS_NX="${comp_mods_nx}",PTS_NY=1
...
#  appears to be currently broken for DP
