...
output_file = "/pscratch/sd/b/bogensch/dp_screamxx_conv/OBS_ARM97.001a/run/OBS_ARM97.001a.horiz_avg.AVERAGE.nhours_x1.1997-06-23-00000.nc"
time_offset = 5.0
...
three_d_vars = [
    ...
    ("rh", "RelativeHumidity_horiz_avg", 1.0/100.0)
]

two_d_vars = [
    ("Prec", "precip_total_surf_mass_flux_horiz_avg", 1.0/1000.0),
    ("prew", "VapWaterPath_horiz_avg",10.0)
]
