...
input_file = "/pscratch/sd/b/bogensch/dp_screamxx_cgils/scream_dp_CGILS.s12.dpv0.12km.implsub.007a/run/scream_dp_CGILS.s12.dpv0.12km.implsub.007a.eam.h0.2003-07-15-00000.nc_avg.nc"
output_file = "/pscratch/sd/b/bogensch/dp_screamxx_cgils/scream_dp_CGILS.s12.dpv0.12km.implsub.007a/run/scream_dp_CGILS.s12.dpv0.12km.implsub.007a.horiz_avg.INSTANT.nsteps_x1.2003-07-15-00000.nc"
time_offset = 0.0
...
three_d_vars = [
    ...
    ("WTHL_SEC", "wthl_sec_horiz_avg", 1./1004./1.2),
    ("WQW_SEC", "wqw_sec_horiz_avg", 1./(2.5*10**6)/1.2),
    ("W_SEC", "w_variance_horiz_avg", 1.0),
    ("W3", "w3_horiz_avg", 1.0),
    ("WTHV_SEC", "sgs_buoy_flux_horiz_avg", 1./1004./1.2),
    ("THL_SEC", "thl_sec_horiz_avg", 1.0),
    ("QW_SEC", "qw_sec_horiz_avg", 1.0/1000./1000.),
    ("SHOC_MIX", "shoc_mix_horiz_avg", 1.0),
